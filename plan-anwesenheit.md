# Anwesenheits-Tracking für Jiracle

## Überblick

Erweiterung um grundlegendes Anwesenheits-Tracking zu ergänzen. Ziel: Arbeitszeit 8-17 Uhr mit 30min Pause erfassen, ohne komplexe Details.
...
**Beispiel für flexible Arbeitszeit:**
...
3. ✅ Status-Indikatoren (✅/⚠️)
4. 🔄 Detaillierte Anwesenheitstabelle mit (a) Tastenkürzel

#### Anwesenheitstabelle

Wenn man in der Wochenansicht (a) drückt, öffnet sich eine detaillierte Anwesenheitstabelle:

```
           Mo     Di     Mi     Do     Fr
Start     08:30  08:15  08:00  08:45  08:30
Ende      17:00  17:15  16:45  17:30  17:00
Pause     30m    30m    45m    30m    30m
```

**UI Details:**

- Jede Spalte = ein Wochentag (Mo-Fr)
- Zeile 1: Startzeit (Time Input Field wie 08:30)
- Zeile 2: Endzeit (Time Input Field wie 17:00)
- Zeile 3: Pause (CustomNumberField für Minuten)
- Time Input Fields: Ähnlich wie CustomNumberField, aber für Uhrzeiten mit Hoch/Runter Navigation
...
```
source/attendance/
├── AttendanceManager.ts         # Check-in/out logic
├── AttendanceCSVStorage.ts      # CSV read/write operations
└── AttendanceCalculations.ts    # Time calculations

source/components/
├── AttendanceRow.tsx            # Row in weekly view
├── AttendanceTable.tsx          # Detaillierte Anwesenheitstabelle
└── TimeInputField.tsx           # Uhrzeiten-Eingabefeld (08:30 Format)
...
✅ **Unkompliziert**: Nur das Nötigste, keine komplexen Pausendetails  
...
Das deckt deine Bedürfnisse ab: 8-17 Uhr Arbeitszeit mit 30min Pause, ohne den Overhead von detailliertem Pausenmanagement.
