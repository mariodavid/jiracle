...
import {type WeeklyWorklogSummary} from '../domain/weekly-worklog-summary.js';
...
import {useIssueGroups} from '../hooks/use-issue-groups.js';
import type {IssueGroup} from '../services/issue-group-manager.js';
import {
	calculateDailyTotals,
	formatHours,
	truncateText,
} from '../utils/timetable-calculations.js';
import {calculateFocusableItems} from '../utils/focusable-item-calculator.js';
import {findInitialFocusItem} from '../services/grid-navigation-service.js';
import {useTableNavigation} from '../hooks/use-table-navigation.js';
import {AttendanceFooterRows} from './attendance-footer-rows.js';
import {AttendanceRows} from './attendance-rows.js';
import {FocusableCell} from './focusable-cell.js';
