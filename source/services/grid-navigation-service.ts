import type {FocusableItem} from '../utils/focusable-item-calculator.js';
...
export function findInitialFocusItem(
	focusableItems: FocusableItem[],
...
export function navigateInDirection(
	...
	switch (direction) {
		case 'up': {
			newIndex = navigateUp(focusedCell, focusableItems);
			break;
		}

		case 'down': {
			newIndex = navigateDown(focusedCell, focusableItems);
			break;
		}

		case 'left': {
			newIndex = navigateLeft(focusedCell, focusableItems, columnCount);
			break;
		}

		case 'right': {
			newIndex = navigateRight(focusedCell, focusableItems, columnCount);
			break;
		}
